...
export default class Notifiction extends LightningElement {
    showNotification = false;
    message
    variant

    get notifyClasses(){
        let variantClasses = this.variant === 'success' ? 'slds-theme_success':
        this.variant === 'warning' ? 'slds-theme_warning':
        this.variant === 'error' ? 'slds-theme_error' : 'slds-theme_info';

        return `slds-notify slds-notify_toast ${variantClasses}`;
    }
